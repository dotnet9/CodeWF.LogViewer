...
internal sealed class CodeWFUserLogState : IReadOnlyList<KeyValuePair<string, object?>>
{
    ...
    public CodeWFUserLogState(string userMessage, string messageTemplate, object?[] args)
    {
        ...
        var properties = new List<KeyValuePair<string, object?>>(args.Length + 2);
        ...
        properties.Add(new KeyValuePair<string, object?>(CodeWFLogPropertyNames.UserMessage, userMessage));
